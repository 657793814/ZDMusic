...
export function VolumeControl({ volume, onChange }: Props) {
  ...
  return (
    <div className="flex items-center gap-2.5 max-w-[180px]">
      <span className="shrink-0" style={{ color: "var(--color-outline)" }} aria-hidden>
        {v <= 0.001 ? (
      ...
      <div className="relative flex flex-1 items-center" style={{ height: "18px" }}>
        ...
        <input
          ...
          className={[
            ...
            "[&::-webkit-slider-thumb]:shadow-[0_0_8px_color-mix(in_srgb,var(--color-primary)_60%,transparent)]",
            ...
            "[&::-moz-range-thumb]:shadow-[0_0_8px_color-mix(in_srgb,var(--color-primary)_60%,transparent)]",
